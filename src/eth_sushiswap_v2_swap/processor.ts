...
export const ETH_ADDRESS:string ='0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac'.toLowerCase()
...
export const processor = new EvmBatchProcessor()
    ...
    .addLog({
        address: [ETH_ADDRESS],
        topic0: [sushiV2EthFactoryAbi.events.PairCreated.topic],
    })
    .addLog({
        topic0: [sushiV2EthPoolAbi.events.Swap.topic],
        transaction: true,
      });
