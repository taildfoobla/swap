...
import {ABI_JSON} from './pancakeswap_v3_binance_pool.abi'
...
export const events = {
    ...
    SetFeeProtocol: new LogEvent<([feeProtocol0Old: number, feeProtocol1Old: number, feeProtocol0New: number, feeProtocol1New: number] & {feeProtocol0Old: number, feeProtocol1Old: number, feeProtocol0New: number, feeProtocol1New: number})>(
        abi, '0xb3159fed3ddfba67bae294599eafe2d0ec98c08bb38e0e5fb87d33154b6e05aa'
    ),
    SetLmPoolEvent: new LogEvent<([addr: string] & {addr: string})>(
        abi, '0x29983690a85a11696ce8a357993744f8d5a74fde14653e517cc2f8608a7235e9'
    ),
    Swap: new LogEvent<([sender: string, recipient: string, amount0: bigint, amount1: bigint, sqrtPriceX96: bigint, liquidity: bigint, tick: number, protocolFeesToken0: bigint, protocolFeesToken1: bigint] & {sender: string, recipient: string, amount0: bigint, amount1: bigint, sqrtPriceX96: bigint, liquidity: bigint, tick: number, protocolFeesToken0: bigint, protocolFeesToken1: bigint})>(
        abi, '0x19b47279256b2a23a1665c810c8d55a1758940ee09377d4f8d26497a3577dc83'
    ),
}
...
export const functions = {
    ...
    observations: new Func<[_: bigint], {}, ([blockTimestamp: number, tickCumulative: bigint, secondsPerLiquidityCumulativeX128: bigint, initialized: boolean] & {blockTimestamp: number, tickCumulative: bigint, secondsPerLiquidityCumulativeX128: bigint, initialized: boolean})>(
        abi, '0x252c09d7'
    ),
    ...
    positions: new Func<[_: string], {}, ([liquidity: bigint, feeGrowthInside0LastX128: bigint, feeGrowthInside1LastX128: bigint, tokensOwed0: bigint, tokensOwed1: bigint] & {liquidity: bigint, feeGrowthInside0LastX128: bigint, feeGrowthInside1LastX128: bigint, tokensOwed0: bigint, tokensOwed1: bigint})>(
        abi, '0x514ea4bf'
    ),
    ...
    setLmPool: new Func<[_lmPool: string], {_lmPool: string}, []>(
        abi, '0xcc7e7fa2'
    ),
...
export class Contract extends ContractBase {
    ...
    observations(arg0: bigint): Promise<([blockTimestamp: number, tickCumulative: bigint, secondsPerLiquidityCumulativeX128: bigint, initialized: boolean] & {blockTimestamp: number, tickCumulative: bigint, secondsPerLiquidityCumulativeX128: bigint, initialized: boolean})> {
    ...
    positions(arg0: string): Promise<([liquidity: bigint, feeGrowthInside0LastX128: bigint, feeGrowthInside1LastX128: bigint, tokensOwed0: bigint, tokensOwed1: bigint] & {liquidity: bigint, feeGrowthInside0LastX128: bigint, feeGrowthInside1LastX128: bigint, tokensOwed0: bigint, tokensOwed1: bigint})> {
    ...
    tickBitmap(arg0: number): Promise<bigint> {
        return this.eth_call(functions.tickBitmap, [arg0])
    }
    ...
    ticks(arg0: number): Promise<([liquidityGross: bigint, liquidityNet: bigint, feeGrowthOutside0X128: bigint, feeGrowthOutside1X128: bigint, tickCumulativeOutside: bigint, secondsPerLiquidityOutsideX128: bigint, secondsOutside: number, initialized: boolean] & {liquidityGross: bigint, liquidityNet: bigint, feeGrowthOutside0X128: bigint, feeGrowthOutside1X128: bigint, tickCumulativeOutside: bigint, secondsPerLiquidityOutsideX128: bigint, secondsOutside: number, initialized: boolean})> {
