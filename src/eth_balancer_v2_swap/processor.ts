...
export const ETH_ADDRESS:string ='0xA5bf2ddF098bb0Ef6d120C98217dD6B141c74EE0'.toLowerCase()
...
export const processor = new EvmBatchProcessor()
    ...
    .addLog({
        address: [ETH_ADDRESS],
        topic0: [balancerV1EthFactoryAbi.events.PoolCreated.topic],
    })
    .addLog({
        topic0: [balancerV1EthPoolAbi.events.Swap.topic],
        transaction: true,
      });
